...
Item {
    ...
    Keys.onReturnPressed: {
        Limoo.deleteFiles(image_delete.sources)
    ...
    Rectangle {
        id: delete_btn
        y: started? image_delete.height/2 - (delete_btn.height+cancel_btn.height+10*physicalPlatformScale)/2 : -height
    ...
    Rectangle {
        id: cancel_btn
        y: started? image_delete.height/2 + (delete_btn.height-cancel_btn.height+10*physicalPlatformScale)/2 : parent.height
